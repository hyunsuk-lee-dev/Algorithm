...
{
    /// <summary>
    /// https://programmers.co.kr/learn/courses/30/lessons/42627?language=csharp
    /// Heap
    /// </summary>
    public static class DiscController
    {
        ...
        /// </summary>
        /// <param name="jobs">각 작업에 대해 [작업이 요청되는 시점, 작업의 소요시간] 을 담은 2차원 배열</param>
        /// <returns>작업의 요청부터 종료까지 걸린 시간의 평균을 가장 줄이는 방법으로 처리하면 평균이 얼마가 되는지 (단, 소수점 이하의 수는 버립니다)</returns>
